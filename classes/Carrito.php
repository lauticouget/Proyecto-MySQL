...
// CONSTRUCTOR
    public function __construct(){
        // Para construir: Extraer el carrito de Session, y si no está seteado = NULL.
        $this->cart_contents = !empty($_SESSION['cart_contents'])?$_SESSION['cart_contents']:NULL;
        if ($this->cart_contents === NULL){
            // Si es NUll seteas precio-total y items-totales en 0.
            $this->cart_contents = ['cart_total' => 0, 'total_items' => 0];
        }
    }
    
//   CONTENTS(): Devuelve array del carrito completo
